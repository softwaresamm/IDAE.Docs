...
Este documento describe cómo habilitar el parámetro que controla la visibilidad de la sección **Estado Equipo** al reportar una orden de trabajo desde la App, permitiendo mostrar dicha sección únicamente cuando la orden de trabajo tiene un equipo asociado.
