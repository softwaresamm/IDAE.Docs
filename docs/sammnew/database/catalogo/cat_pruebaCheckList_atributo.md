...
description: Tabla cat_pruebaCheckList_atributo del módulo Catálogo
tags: [database, cat]
---
...
Tabla cat_pruebaCheckList_atributo del módulo Catálogo.
...
- Nombre real en base de datos: `cat_pruebaCheckList_atributo`
...
-- Consulta con joins
SELECT t.*, u.usuario
FROM [cat_pruebaCheckList_atributo] t
