---
sidebar_position: 27
title: cat_sistema_catalogo.equipo
description: Tabla cat_sistema_catalogo.equipo del módulo Catálogo
tags: [database, cat]
---

# cat_sistema_catalogo.equipo

## Descripción

Tabla cat_sistema_catalogo.equipo del módulo Catálogo.
...
|---------|------|------|-------|-------------|
| sistema_catalogo.equipo | VARCHAR | ✗ | - | - |
...
- Nombre real en base de datos: `cat_sistema_catalogo.equipo`
...
```sql
-- Consulta básica
SELECT * FROM [cat_sistema_catalogo.equipo] WHERE active = 1;

-- Consulta con joins
SELECT t.*, u.usuario
FROM [cat_sistema_catalogo.equipo] t
