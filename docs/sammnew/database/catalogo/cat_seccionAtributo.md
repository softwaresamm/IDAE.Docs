...
description: Tabla cat_seccionAtributo del módulo Catálogo
tags: [database, cat]
---
...
Tabla cat_seccionAtributo del módulo Catálogo.
...
- Nombre real en base de datos: `cat_seccionAtributo`
