...
description: Tabla ort_reporteTecnico_ot del módulo Órdenes de Trabajo
tags: [database, ort]
---
...
Tabla ort_reporteTecnico_ot del módulo Órdenes de Trabajo.
...
- Nombre real en base de datos: `ort_reporteTecnico_ot`
