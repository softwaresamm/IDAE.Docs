...
description: Tabla ort_canalAtencion del módulo Órdenes de Trabajo
tags: [database, ort]
---
...
Tabla ort_canalAtencion del módulo Órdenes de Trabajo.
...
- Nombre real en base de datos: `ort_canalAtencion`
