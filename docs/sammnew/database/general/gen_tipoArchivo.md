...
description: Tabla gen_tipoArchivo del módulo General / Configuración
tags: [database, gen]
---
...
Tabla gen_tipoArchivo del módulo General / Configuración.
...
- Nombre real en base de datos: `gen_tipoArchivo`
