...
description: Tabla lic_licencia_parametro del módulo Licencias
tags: [database, lic]
---
...
Tabla lic_licencia_parametro del módulo Licencias.
...
- Nombre real en base de datos: `lic_licencia_parametro`
