...
description: Tabla ter_sucursal_listaprecio del módulo Terceros
tags: [database, ter]
---
...
Tabla ter_sucursal_listaprecio del módulo Terceros.
...
- Nombre real en base de datos: `ter_sucursal_listaprecio`
...
-- Consulta con joins
SELECT t.*, u.usuario
FROM [ter_sucursal_listaprecio] t
