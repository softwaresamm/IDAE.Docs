...
description: Tabla ter_cargoContacto del módulo Terceros
tags: [database, ter]
---
...
Tabla ter_cargoContacto del módulo Terceros.
...
- Nombre real en base de datos: `ter_cargoContacto`
