...
description: Tabla ter_tercero_usuario del módulo Terceros
tags: [database, ter]
---
...
Tabla ter_tercero_usuario del módulo Terceros.
...
- Nombre real en base de datos: `ter_tercero_usuario`
