...
description: Tabla dis_motivoEvento del módulo Despacho
tags: [database, dis]
---
...
Tabla dis_motivoEvento del módulo Despacho.
...
- Nombre real en base de datos: `dis_motivoEvento`
