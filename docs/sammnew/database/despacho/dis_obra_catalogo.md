...
description: Tabla dis_obra_catalogo del módulo Despacho
tags: [database, dis]
---
...
Tabla dis_obra_catalogo del módulo Despacho.
...
- Nombre real en base de datos: `dis_obra_catalogo`
