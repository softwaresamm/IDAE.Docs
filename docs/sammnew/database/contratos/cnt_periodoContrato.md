...
description: Tabla cnt_periodoContrato del módulo Contratos
tags: [database, cnt]
---
...
Tabla cnt_periodoContrato del módulo Contratos.
...
- Nombre real en base de datos: `cnt_periodoContrato`
