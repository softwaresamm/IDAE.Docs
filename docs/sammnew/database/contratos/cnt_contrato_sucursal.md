...
description: Tabla cnt_contrato_sucursal del módulo Contratos
tags: [database, cnt]
---
...
Tabla cnt_contrato_sucursal del módulo Contratos.
...
- Nombre real en base de datos: `cnt_contrato_sucursal`
