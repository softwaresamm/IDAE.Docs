...
description: Tabla cnt_contratoDetalleVisita del módulo Contratos
tags: [database, cnt]
---
...
Tabla cnt_contratoDetalleVisita del módulo Contratos.
...
| diaHabil | INTEGER | ✗ | - | - |
| fechaInactivaInicial_ff | DATETIME | ✓ | - | - |
| fechaInactivaFinal_ff | DATETIME | ✓ | - | - |
...
- Nombre real en base de datos: `cnt_contratoDetalleVisita`
...
-- Consulta con joins
SELECT t.*, u.usuario
FROM [cnt_contratoDetalleVisita] t
