---
sidebar_position: 21
title: doc_documento.salida
description: Tabla doc_documento.salida del módulo Documentos
tags: [database, doc]
---
...
Tabla doc_documento.salida del módulo Documentos.
...
- Nombre real en base de datos: `doc_documento.salida`
...
```sql
-- Consulta básica
SELECT * FROM [doc_documento.salida] WHERE active = 1;

-- Consulta con joins
SELECT t.*, u.usuario
FROM [doc_documento.salida] t
