...
description: Tabla doc_subtipoLectura del módulo Documentos
tags: [database, doc]
---
...
Tabla doc_subtipoLectura del módulo Documentos.
...
- Nombre real en base de datos: `doc_subtipoLectura`
