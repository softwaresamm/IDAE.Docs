...
sidebar_position: 4
title: doc_documento
description: Tabla doc_documento del módulo Documentos
tags: [database, doc]
---
...
Tabla doc_documento del módulo Documentos.
...
| subtotalPlaneado | FLOAT | ✗ | - | - |
| descuentoPlaneado | FLOAT | ✗ | - | - |
| ivaPlaneado | FLOAT | ✗ | - | - |
| totalPlaneado | FLOAT | ✗ | - | - |
| costoPlaneado | FLOAT | ✗ | - | - |
...
- Nombre real en base de datos: `doc_documento`
