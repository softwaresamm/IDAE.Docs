...
description: Tabla doc_opcionCondicion del módulo Documentos
tags: [database, doc]
---
...
Tabla doc_opcionCondicion del módulo Documentos.
...
- Nombre real en base de datos: `doc_opcionCondicion`
