...
description: Tabla doc_motivoestado del módulo Documentos
tags: [database, doc]
---
...
Tabla doc_motivoestado del módulo Documentos.
...
- Nombre real en base de datos: `doc_motivoestado`
