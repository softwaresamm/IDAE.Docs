...
description: Tabla doc_subtipoDocumento_atributo del módulo Documentos
tags: [database, doc]
---
...
Tabla doc_subtipoDocumento_atributo del módulo Documentos.
...
- Nombre real en base de datos: `doc_subtipoDocumento_atributo`
...
-- Consulta con joins
SELECT t.*, u.usuario
FROM [doc_subtipoDocumento_atributo] t
