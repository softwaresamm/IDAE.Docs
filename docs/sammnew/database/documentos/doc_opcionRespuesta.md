...
description: Tabla para gestionar opcionRespuesta en el sistema SAMM
tags: [database, doc]
---
...
Tabla para gestionar opcionRespuesta en el sistema SAMM.
...
SELECT * FROM doc_opcionRespuesta
WHERE active = 1
ORDER BY id DESC;
```
