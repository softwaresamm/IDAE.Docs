...
description: Tabla para gestionar actividad_etapa en el sistema SAMM
tags: [database, pro]
---
...
Tabla para gestionar actividad_etapa en el sistema SAMM.
...
SELECT * FROM pro_actividad_etapa
WHERE active = 1
ORDER BY id DESC;
```
