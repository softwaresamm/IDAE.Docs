---
sidebar_position: 13
title: pro_ejecutor_archivo
description: Tabla para gestionar ejecutor_archivo en el sistema SAMM
tags: [database, pro]
---

# pro_ejecutor_archivo

## Descripción

Tabla para gestionar ejecutor_archivo en el sistema SAMM.
...
```sql
-- Consulta básica
SELECT * FROM pro_ejecutor_archivo WHERE active = 1;

-- Consulta con joins (si aplica)
SELECT * FROM pro_ejecutor_archivo
WHERE active = 1
ORDER BY id DESC;
```
