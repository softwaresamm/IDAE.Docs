...
description: Tabla pro_factorexito del módulo Proyectos
tags: [database, pro]
---
...
Tabla pro_factorexito del módulo Proyectos.
...
- Nombre real en base de datos: `pro_factorexito`
