...
description: Tabla equ_estadoEquipo del módulo Equipos
tags: [database, equ]
---
...
Tabla equ_estadoEquipo del módulo Equipos.
...
- Nombre real en base de datos: `equ_estadoEquipo`
