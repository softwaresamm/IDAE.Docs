...
sidebar_position: 22
title: equ_tipoFalla
description: Tabla equ_tipoFalla del módulo Equipos
tags: [database, equ]
---
...
Tabla equ_tipoFalla del módulo Equipos.
...
- Nombre real en base de datos: `equ_tipoFalla`
