...
description: Tabla equ_estadoPrestamo del módulo Equipos
tags: [database, equ]
---
...
Tabla equ_estadoPrestamo del módulo Equipos.
...
- Nombre real en base de datos: `equ_estadoPrestamo`
