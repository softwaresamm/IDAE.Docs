...
description: Tabla equ_tipoTrazabilidad del módulo Equipos
tags: [database, equ]
---
...
Tabla equ_tipoTrazabilidad del módulo Equipos.
...
- Nombre real en base de datos: `equ_tipoTrazabilidad`
