...
description: Tabla equ_equipo_itemDocumento del módulo Equipos
tags: [database, equ]
---
...
Tabla equ_equipo_itemDocumento del módulo Equipos.
...
- Nombre real en base de datos: `equ_equipo_itemDocumento`
...
-- Consulta con joins
SELECT t.*, u.usuario
FROM [equ_equipo_itemDocumento] t
