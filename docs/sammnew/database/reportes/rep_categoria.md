...
sidebar_position: 3
title: rep_categoria
description: Tabla rep_categoria del módulo Reportes
tags: [database, rep]
---
...
Tabla rep_categoria del módulo Reportes.
...
- Nombre real en base de datos: `rep_categoria`
