...
description: Tabla rep_tipoCampoReporte del módulo Reportes
tags: [database, rep]
---
...
Tabla rep_tipoCampoReporte del módulo Reportes.
...
- Nombre real en base de datos: `rep_tipoCampoReporte`
